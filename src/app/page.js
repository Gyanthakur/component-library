        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
            ...
            <div className="relative md:w-1/2 max-w-lg mx-auto">
              <div className="bg-gradient-to-br from-blue-400 via-purple-500 to-pink-500 rounded-3xl shadow-2xl w-full h-96 flex items-center justify-center bg-[length:200%_200%] gradient-shift">
                <div className="text-white text-center">
                  ...
                  <h3 className="text-2xl !text-gray-50 font-bold mb-2 transition-all duration-700 ease-out hover:scale-105">{t('beautiful_components')}</h3>
                  <p className="text-blue-100">{t('ready_to_use')}</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="max-w-7xl mx-auto px-6 py-20">
            <h2 className="text-4xl font-extrabold mb-16 text-center">
              {t('featured_components')}
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
              <SimpleCard
                title={t('simple_card_title')}
                description={t('simple_card_description')}
              />
              <FeatureCard
                title={t('feature_card_title')}
                description={t('feature_card_description')}
              />
              <PricingCard
                plan={t('pricing_card_plan')}
                price={t('pricing_card_price')}
                features={[t('pricing_card_features.0'), t('pricing_card_features.1'), t('pricing_card_features.2')]}
              />
              <DataCard title={t('data_card_title')} value="27" icon={t('data_card_icon')} trend={t('data_card_trend')} />
            </div>
          </section>
