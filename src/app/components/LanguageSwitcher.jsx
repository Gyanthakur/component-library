...
const LanguageSwitcher = () => {
  ...
  const [locale, setLocale] = React.useState(() => {
    const savedLocale = getCookie('selected-language');
    return savedLocale && locales.includes(savedLocale) ? savedLocale : 'en';
  ...
  const changeLanguage = (lang) => {
    ...
    // Additional logic to change the app's language can be added here
  };
  const languageNames = {
    en: 'English',
    es: 'Español',
  ...
  return (
    <div className="relative group">
      ...
      <div className={`absolute right-0 mt-2 w-48 rounded-xl bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 py-2 transition-all duration-200 z-50 ${
