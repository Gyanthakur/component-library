    ...
    <div className="max-w-6xl mx-auto px-4 py-12 space-y-16">
      ...
      <section className="bg-gray-50 p-8 rounded-2xl">
        ...
        <div className="text-center">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">{t('techStack.additionalTools.title')}</h3>
          <div className="flex flex-wrap justify-center gap-3">
            <span className="bg-white dark:bg-gray-700 px-4 py-2 rounded-full text-sm text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-600">{t('techStack.additionalTools.eslint')}</span>
            <span className="bg-white dark:bg-gray-700 px-4 py-2 rounded-full text-sm text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-600">{t('techStack.additionalTools.prettier')}</span>
            <span className="bg-white dark:bg-gray-700 px-4 py-2 rounded-full text-sm text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-600">{t('techStack.additionalTools.lucide')}</span>
            <span className="bg-white dark:bg-gray-700 px-4 py-2 rounded-full text-sm text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-600">{t('techStack.additionalTools.postcss')}</span>
            <span className="bg-white dark:bg-gray-700 px-4 py-2 rounded-full text-sm text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-600">{t('techStack.additionalTools.git')}</span>
          </div>
        </div>
      </section>
